...
float SURFFilterNode::calc_thresh(const std::vector<cv::Mat>& data, const cv::Rect& roi) const
{
...
void SURFFilterNode::setThreshold(const std::vector<cv::Mat>& data, const cv::Rect& roi)
{
