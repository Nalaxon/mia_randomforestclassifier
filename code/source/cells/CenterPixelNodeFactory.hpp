...
public:
  ...
  CenterPixelNodeFactory(PatchParameter params) : m_params(params), m_dist_rows(0, params.patch_height-1), m_dist_cols(0, params.patch_width-1)
  {
  }

protected:
  virtual CenterPixelNode* createRandomNode();
