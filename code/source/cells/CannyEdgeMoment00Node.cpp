...
float CannyEdgeMoment00Node::calc_thresh(const std::vector<cv::Mat>& data, const cv::Rect& roi) const
{
...
void CannyEdgeMoment00Node::setThreshold(const std::vector<cv::Mat>& data, const cv::Rect& roi)
{
