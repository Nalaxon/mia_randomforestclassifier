#ifndef TWOPIXELGRADIENTNODEFACTORY_HPP
#define TWOPIXELGRADIENTNODEFACTORY_HPP
...
class TwoPixelGradientNodeFactory : public NodeFactory<CellLabel, std::vector<cv::Mat>, cv::Rect>
{
