...
TwoRegionsGradientNode::Direction TwoRegionsGradientNode::split(const std::vector<cv::Mat>& mat, const cv::Rect& roi) const
{
	std::vector<cv::Mat> mat1(4), mat2(4);
	
	cv::split(mat[0](m_region1), mat1);
	cv::split(mat[0](m_region2), mat2);
